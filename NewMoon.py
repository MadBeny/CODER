...
class AgentResponse(BaseModel):
    ...
    trajectory: str = Field(description="Internal roadmap, it must be JSON.")
    status_summary: str = Field(description="status update. E.g., 'Scanning filesystem'. No pipes, no arrows.")
    synthesis: str = Field(description="reasoning")
    action: Optional[ToolCall] = Field(description="The tool to call, or null if finishing")
    completion_summary: Optional[str] = Field(description="The final answer")
...
class RichUI:
    ...
    def node_context(self, name: str, is_error: bool = False):
        ...
        tag_style = "white on red" if is_error else "white on grey11"
    ...
    def log_final(self, text: str):
        ...
        self.console.print("\n[green italic] Accomplished[/green italic]")
...
class LangChainEngine:
    ...
    def _get_system_prompt(self) -> str:
        ...
        [OUTPUT REQUIREMENT]
        You MUST respond using the structured JSON schema provided by the system. 
        Strictly adhere to the formatting constraints defined within each field's description
        """
