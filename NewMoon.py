...
class AgentResponse(BaseModel):
    ...
    trajectory: str = Field(description="Internal roadmap")
    status_summary: str = Field(description="status update. E.g., 'Scanning filesystem', 'Refining logic', 'Compiling report'. No pipes, no arrows.")
    synthesis: str = Field(description="Deep reasoning")
    action: Optional[ToolCall] = Field(description="The tool to call, or null if finishing")
    completion_summary: Optional[str] = Field(description="Final summary")
